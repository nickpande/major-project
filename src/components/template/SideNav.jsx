  ...
  return (
       <div className='w-[20%] h-full  border-r-2 border-zinc-200 p-10'>
        <h1 className='text-2xl text-white  font-bold'>
            <i class=" text-[#6565CD] ri-tv-fill text-2xl mr-2"></i>
        ...
        <i class=" mr-2 ri-fire-fill"></i>  Trending Movies 
        </Link>
        <Link className="hover:bg-[#6565CD] rounded-lg duration-300  hover:text-white  p-3">
        <i class="mr-2 ri-bard-fill"></i>   Trending Series 
        </Link>
        <Link className="hover:bg-[#6565CD] rounded-lg duration-300  hover:text-white  p-3">
        <i class=" mr-2 ri-movie-2-fill"></i>  Movies 
        </Link>
        <Link className="hover:bg-[#6565CD] rounded-lg duration-300  hover:text-white  p-3">
        <i class="mr-2 ri-slideshow-3-fill"></i> series 
        </Link>
        <Link className="hover:bg-[#6565CD] rounded-lg duration-300  hover:text-white  p-3">
        <i class="mr-2 ri-user-line"></i> People
        </Link>
