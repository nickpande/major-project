...
const MovieDetails = () => {
  ...
  return info ? (
    <div
      ...
      className="w-screen relative h-[135vh] px-[10%]"
    >
      {/* Navigation Bar */}
      ...
      <div className="w-full flex">
        ...
        <div className='content ml-10  text-white'>
          <h1 className='text-5xl font-black text-white'>
            ...
            <small className='text-2 xl font-bold text-zinc-300'> ({info.detail.release_date.split("-")[0]})</small>
          </h1>
          ...
          <h1 className='text-2xl mt-5  '>movie translated   </h1>
